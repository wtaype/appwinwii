...
class PantallaAcerca extends StatelessWidget {
  ...
  Widget build(BuildContext ctx) => Scaffold(
    ...
    appBar: AppBar(
      ...
      centerTitle: true,
      leading: IconButton(
        icon: const Icon(Icons.arrow_back, color: AppCSS.F),
    ...
    body: SingleChildScrollView(
      ...
      child: Column(children: [
        ...
        Glass(child: Column(children: [
          Row(children: [
            Container(
              ...
              child: const Icon(Icons.language, color: AppCSS.F, size: 22),
            ),
            AppCSS.ghm,
        ...
        Container(
          ...
          child: Column(children: [
            const Icon(Icons.favorite, size: 32, color: AppCSS.F),
            AppCSS.gs,
            Text('Creado con ❤️', style: AppEs.h3.copyWith(color: AppCSS.F)),
            AppCSS.gs,
            Text('Wilder Taype', style: AppEs.bd.copyWith(color: AppCSS.F, fontWeight: FontWeight.w700)),
            Text('Creador de ${wii.app}', style: AppEs.sm.copyWith(color: AppCSS.F.withOpacity(0.8))),
            AppCSS.gs,
            Container(
              ...
              child: Text(wii.autor, style: AppEs.bdS.copyWith(color: AppCSS.F)),
            ),
          ]),
        ),
        AppCSS.gm,
